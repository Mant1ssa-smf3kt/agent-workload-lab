# w3-truncate · 第一道门估计（单租户、无驱逐、不含延迟）
...
|---|---|---|---|---|---|---|
| w3-truncate | 0.9101 | 0.9101 | 0.943 / 0.993 / 0.996 | 7.5% | 13.69M | 837 |
| w3-truncate（不含合成） | 0.9100 | 0.9100 | 0.942 / 0.993 / 0.996 | 7.5% | 13.67M | 835 |
| w3-control（对照） | 0.9633 | 0.9633 | 0.979 / 0.996 / 0.998 | 4.8% | 19.38M | 837 |
| Δ（w3-truncate − w3-control） | -0.0532 (-5.5%) | | | | -5,695,386 | |
