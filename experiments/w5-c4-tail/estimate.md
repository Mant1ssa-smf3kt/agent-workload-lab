# w5-c4-tail · 第一道门估计（单租户、无驱逐、不含延迟）

模型 / tokenizer：Qwen/Qwen3-8B-FP8（tokenizer.json aeb13307a71a… · chat_template a55ee1b16601… · chat_template_kwargs {"enable_thinking": false}）· traces 25 · steps 839（合成 2，warmup 2 不计）· transform system_timestamp {"position": "tail"} · analysis commit d283d498
...
|---|---|---|---|---|---|---|
| w5-c4-tail | 0.9620 | 0.9620 | 0.977 / 0.995 / 0.997 | 4.8% | 19.41M | 837 |
| w5-c4-tail（不含合成） | 0.9620 | 0.9620 | 0.977 / 0.995 / 0.997 | 4.8% | 19.38M | 835 |
| w5-c4（对照） | 0.9633 | 0.9633 | 0.979 / 0.996 / 0.998 | 4.8% | 19.38M | 837 |
| Δ（w5-c4-tail − w5-c4） | -0.0013 (-0.1%) | | | | +24,273 | |
