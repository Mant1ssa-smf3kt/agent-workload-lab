# w5-c8-fcfs · 第一道门估计（单租户、无驱逐、不含延迟）
...
> config 的 concurrency=8；本估计按 c=1、不驱逐算，并发下的驱逐与排队只能上 GPU（docs/findings.md §6）。

| 组 | cache hit（估计） | 上界（缓存无限） | 每请求命中 P50 / P95 / P99 | 命中 < 0.5 的请求 | prompt tok 总 | n |
|---|---|---|---|---|---|---|
| w5-c8-fcfs | 0.9633 | 0.9633 | 0.979 / 0.996 / 0.998 | 4.8% | 19.38M | 837 |
| w5-c8-fcfs（不含合成） | 0.9633 | 0.9633 | 0.979 / 0.996 / 0.997 | 4.8% | 19.36M | 835 |
| w5-c8-lpm（对照） | 0.9633 | 0.9633 | 0.979 / 0.996 / 0.998 | 4.8% | 19.38M | 837 |
| Δ（w5-c8-fcfs − w5-c8-lpm） | +0.0000 (+0.0%) | | | | +0 | |
