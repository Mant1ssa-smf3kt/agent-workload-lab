# w3-timestamp · 第一道门估计（单租户、无驱逐、不含延迟）
...
|---|---|---|---|---|---|---|
| w3-timestamp | 0.1064 | 0.1064 | 0.107 / 0.360 / 0.586 | 98.2% | 19.40M | 837 |
| w3-timestamp（不含合成） | 0.1062 | 0.1062 | 0.107 / 0.353 / 0.572 | 98.3% | 19.38M | 835 |
| w3-control（对照） | 0.9633 | 0.9633 | 0.979 / 0.996 / 0.998 | 4.8% | 19.38M | 837 |
| Δ（w3-timestamp − w3-control） | -0.8569 (-89.0%) | | | | +20,925 | |
