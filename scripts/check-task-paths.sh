...
fail=0
check minimind model/model_minimind.py dataset/lm_dataset.py dataset/dataset.md trainer/trainer_utils.py trainer/train_pretrain.py trainer/train_full_sft.py trainer/train_lora.py trainer/train_dpo.py trainer/train_distillation.py trainer/train_grpo.py scripts/serve_openai_api.py scripts/chat_api.py README.md
check openclaw core/node.py core/memory.py examples/workflow/main.py examples/chatbot_with_memory examples/chatbot_with_tools examples/agent_with_goal tools/builtins/bash.py tools/executor.py tools/mcp/server.py tools/mcp/client.py tools/mcp/example.py tools/builtins/grep.py tools/builtins/read.py tools/builtins/ls.py tools/builtins/find.py tools/builtins/write.py tools/builtins/edit.py tools/builtins/tool_def.py tests/test_memory.py
